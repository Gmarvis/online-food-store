...
export const Checkout = () => {
  ...
  return (
    <div className="paymentSection">
        ...
        <PaymentInputsContainer>
          {({ meta, getCardNumberProps, getExpiryDateProps, getCVCProps }) => (
            <form className="ppc">
              ...
              <p>Package Name: <span className="text-yellow-700">{purchaseFood.name}</span></p>
              <h2>payment amount: <span className="text-yellow-700">${purchaseFood.price}</span></h2>
              <button onClick={handleSubmit} className="paymentBtn">PAY</button>
            </form>
          )}
      ...
      <img src="https://i.pinimg.com/564x/e9/e9/ee/e9e9ee23736effe7a6164ef974ab28ea.jpg" alt="" />
